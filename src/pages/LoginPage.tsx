      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-surface-50 dark:bg-surface-950">
        ...
        >
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            ...
            <h1 className="text-xl font-bold text-surface-900 dark:text-white">FaceTrack AI</h1>
          </div>
          ...
          <div className="card p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {!isLogin && (
                <div>
                  ...
                  <input
                    ...
                    className={`input-premium w-full ${errors.name ? 'border-red-500' : ''}`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`input-premium w-full pl-11 ${errors.email ? 'border-red-500' : ''}`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`input-premium w-full pl-11 pr-11 ${errors.password ? 'border-red-500' : ''}`}
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
              ...
              {!isLogin && (
                <div>
                  <label className="text-sm font-medium text-surface-700 dark:text-surface-300 mb-1.5 block">Confirm Password</label>
                  <div className="relative">
                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-surface-400" />
                    <input
                      type="password"
                      ...
                      className={`input-premium w-full pl-11 ${errors.confirmPassword ? 'border-red-500' : ''}`}
                      placeholder="••••••••"
                    />
                  </div>
              ...
              {isLogin && (
                <div className="flex items-center justify-between">
                  ...
                  <button type="button" className="text-sm text-primary-600 dark:text-primary-400 hover:text-primary-700 font-medium">
                    Forgot password?
                  </button>
                </div>
              )}
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-surface-600 dark:text-surface-400">
                ...
                <button
                  ...
                  className="ml-1 text-primary-600 dark:text-primary-400 hover:text-primary-700 font-medium"
                >
            ...
            {isLogin && (
              <div className="mt-4 p-3 bg-primary-50 dark:bg-primary-900/20 rounded-xl">
                ...
                <p className="text-xs text-primary-600 dark:text-primary-300">Email: admin@company.com</p>
                <p className="text-xs text-primary-600 dark:text-primary-300">Password: admin123</p>
              </div>
            )}
          </div>
        </motion.div>
